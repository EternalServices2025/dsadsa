...
const Vouches = () => {
  ...
  const [vouches, setVouches] = useState<Vouch[]>([
  {
    id: 1,
    username: "retrixzz",
    message: "+rep for Aqua Shop, Wmicrosoft account.",
    rating: 5,
    service: "Microsoft Account",
    date: "2024-01-15"
  },
  ...
  },
  {
    id: 3,
    username: "qmarlin",
    message: "+rep Aqua Shop, fast delivery",
    rating: 5,
  ...
  },
  {
    ...
    message: "Premium bundle is worth every invite! Got multiple accounts at an amazing price. Aqua Shop is the best!",
    rating: 5,
  ...
  },
  {
    id: 7,
    username: "NightFox",
    message: "Aqua Shop came through again. Bought 3 accounts and all work flawlessly.",
    rating: 5,
    service: "Roblox Account",
    date: "2024-01-09"
  },
  ...
  },
  {
    id: 18,
    username: "ChillBuyer",
    message: "Aqua Shop is my go-to for alt accounts. Always smooth.",
    rating: 5,
    service: "Roblox Account",
    date: "2023-12-29"
  },
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            See what our satisfied customers have to say about their experience with Aqua Shop
          </p>
        </div>
